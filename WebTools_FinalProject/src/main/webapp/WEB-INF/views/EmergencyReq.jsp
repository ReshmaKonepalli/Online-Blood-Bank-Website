        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="findadonor.htm">Find A Donor</a></li>
                <li><a href="makearequest.htm">Make A Request</a></li>
                <li><a href="viewmyreqReq.htm">Request Status</a></li>
...
<form:form action ="updateSta.htm" commandName="updateStatus" method ="post"  role="form">
       <table border="1" cellpadding="5" cellspacing="5" class="table table-bordered">
            ...
            <c:forEach var="ra" items="${emerReq}">
                <tr>
                    <td>${ra.Status}</td>
                    <td>${ra.Status}</td>
                    <td>${ra.Status}</td>
