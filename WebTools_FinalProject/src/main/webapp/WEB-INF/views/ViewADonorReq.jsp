...
<body class="hold-transition skin-blue sidebar-mini">
      ...
      <table border="1" cellpadding="4" cellspacing="4" class="table table-bordered">
            <tr>
                <td><b>Status</b></td>
                <td><b>Person ID</b></td>
            ...
            <c:forEach var="ap" items="${applicants}">
                <tr>
                    <td>${ap.status}</td>
                    <td>${ap.bloodDonor.personID}</td>
                    <td>${ap.dateaccepted}</td>
                    <td>${ap.requestAdvert.advertid}</td>
                    <td>${ap.verification}</td>
                    <td><a href="${pageContext.request.contextPath}/downloadcertificate/${ap.ARId}.htm"><button type="button" class="btn btn-primary">Download Certifcate</button></a></td>
                    <td><a href="${pageContext.request.contextPath}/updatestatus/${ap.ARId}.htm"><button type="button" class="btn btn-primary">Update Status</button></a></td>
                </tr>
            </c:forEach>
        </table>
