            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown messages-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="label label-success">${fn:length(requestadvList)}</span>
                </a>
                <ul class="dropdown-menu">
                  <li class="header">You have ${fn:length(requestadvList)} messages</li>
                  <li>
       ...
       <table border="1" cellpadding="5" cellspacing="5" class="table table-bordered">
            ...
            <c:forEach var="ra" items="${requestadvList}">
                <tr>
                    ...
                    <td>${ra.bloodGroup}</td>
                    <td>${ra.message}</td>
                   <%--  <td><a href="acceptreq/${ra.advertid}.htm"><button type="button" class="btn btn-primary">Accept to donate</button></a></td> --%>
