...
<div class="row">
    <div class="col-xs-12 col-sm-8 col-md-8 col-sm-offset-2 col-md-offset-1">
		 ...
		 <form role="form" action="fileUpload.htm" method="post" class="registration-form" enctype="multipart/form-data" >
		    ...
		    <div class="row">
                ...
                <input type="file" name="fileName" id="fileName" required></input>
                </div>
			</div>
			<div>
			...
			<hr class="colorgraph">
			<div class="row" >
				<div class="col-xs-12 col-md-4 col-md-offset-4"><input type="submit" value="Update Certificate" class="btn btn-primary btn-block btn-md" tabindex="7"></div>
			</div>
		</form>
	</div>
</div>
